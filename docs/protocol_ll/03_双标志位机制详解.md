...
**官方解释**：
- 关于清理机制的详细解释，参见 NVIDIA 开发者在 GitHub issue 中的回答：清理机制会在 32 位周期内触发两次（"reset flags twice in the complete 32-bit cycle, for all 8 steps"），分别在 2^31 和 2^32 附近，每次覆盖所有 8 个 slot
